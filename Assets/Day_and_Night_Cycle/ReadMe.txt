2016-2021 Spyblood Games

Important Note: In order for the dynamic ambient colors to work, you must set the scene's environmental lighting source to "Gradient". This can be 
found in the Lighting settings, under Window -> Rendering
